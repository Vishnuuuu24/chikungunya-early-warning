...
echo "============================================================"
echo "CHIKUNGUNYA EWS - VERSION 1.1 REPRODUCTION"
echo "============================================================"
...
python -c "import xgboost" 2>/dev/null || {
    echo "ERROR: XGBoost not available."
    echo "On macOS, run: brew install libomp"
    exit 1
}
...
echo "Running baseline training (with XGBoost)..."
cd "$PROJECT_ROOT"
python experiments/03_train_baselines.py --config config/config_default.yaml

echo ""
echo "============================================================"
echo "V1.1 REPRODUCTION COMPLETE"
echo "============================================================"
